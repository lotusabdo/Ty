...
from Wevy.Data import get_dev, get_group, get_channel, get_dev_name
...
ᴘᴏᴡᴇʀᴇᴅ ʙʏ @oYsYY""",
        ...
        reply_markup=InlineKeyboardMarkup([
[InlineKeyboardButton("ძᥱ᥎ ხ᥆ƚ", url=f"https://t.me/oYsYY")],
...
[InlineKeyboardButton("Add to your group or channel ✨♥",url=f"https://t.me/{bot.username}?startgroup=true")],]),disable_web_page_preview=True)
...
💡 ɪғ ʏᴏụ ʜᴀᴠᴇ ᴀ ғᴏʟʟᴏᴡ-ụᴘ ǫụᴇѕᴛɪᴏɴѕ ᴀʙᴏụᴛ ᴛʜɪѕ ʙᴏᴛ, ʏᴏụ ᴄᴀɴ ᴛᴇʟʟ ɪᴛ ᴏɴ ᴍʏ ѕụᴘᴘᴏʀᴛ ᴄʜᴀᴛ ʜᴇʀᴇ: @oYsYY
⋮ ᴅᴇᴠᴇʟᴏᴘᴇʀ ʙʏ @oYsYY""",
        reply_markup=InlineKeyboardMarkup(
...
💡 **في حال واجهت اي مشكلة اخري يمكنك التواصل مع المطور**
◖⋮◗ ᴅᴇᴠᴇʟᴏᴘᴇʀ ʙʏ  @oYsYY""",
        reply_markup=InlineKeyboardMarkup(
